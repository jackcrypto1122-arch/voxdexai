...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/voxdex-logo.png?v=2", type: "image/png" },
      { rel: "shortcut icon", href: "/voxdex-logo.png?v=2", type: "image/png" },
      { rel: "apple-touch-icon", href: "/voxdex-logo.png?v=2" },
    ],
  }),
