...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/vozdex-logo.svg.jpeg", type: "image/jpeg" },
      { rel: "shortcut icon", href: "/vozdex-logo.svg.jpeg", type: "image/jpeg" },
      { rel: "apple-touch-icon", href: "/vozdex-logo.svg.jpeg" },
    ],
  }),
